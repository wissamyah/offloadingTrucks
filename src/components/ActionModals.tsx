      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <label htmlFor="waybill" className="block text-sm font-medium text-gray-300 mb-2">
            Waybill Number <span className="text-red-400">*</span>
          </label>
          <input
            id="waybill"
            type="text"
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Mark as Offloaded">
      <form onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="netWeight" className="block text-sm font-medium text-gray-300 mb-2">
              Net Weight (kg) <span className="text-red-400">*</span>
            </label>
            <input
              id="netWeight"
              type="number"
          ...
          <div>
            <label htmlFor="deduction" className="block text-sm font-medium text-gray-300 mb-2">
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Truck Details">
      <form onSubmit={handleSubmit}>
        <div className="space-y-4">
          <div>
            <label htmlFor="edit-supplier" className="block text-sm font-medium text-gray-300 mb-2">
          ...
          <div>
            <label htmlFor="edit-bags" className="block text-sm font-medium text-gray-300 mb-2">
          ...
          <div>
            <label htmlFor="edit-moisture" className="block text-sm font-medium text-gray-300 mb-2">
          ...
          <div>
            <label htmlFor="edit-truck" className="block text-sm font-medium text-gray-300 mb-2">
